...
- [10. Install DOCA OFED and Mellanox Firmware Tools on the Host](#10-install-doca-ofed-and-mellanox-firmware-tools-on-the-host)

- [11. Install CUDA Driver](#11-install-cuda-driver)

- [12. Install Docker and Nvidia Container Toolkit](#12-install-docker-and-nvidia-container-toolkit)

- [13. Install ptp4l and phc2sys](#13-install-ptp4l-and-phc2sys)

- [14. Setup the Boot Configuration Service](#14-setup-the-boot-configuration-service)

- [15. Validating software-component versions and system configurations](#15-validating-software-component-versions-and-system-configurations)  
